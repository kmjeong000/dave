...
public:
  ...
  static inline void PreComputeCoeff(
    double period, double t, double wave_angle, double & w, double & wt, double & k,
...
//////////////////////////////////////////////////
LinearRegularWaveSimulation::Impl::Impl(double lx, double ly, Index nx, Index ny)
...
//////////////////////////////////////////////////
void LinearRegularWaveSimulation::Impl::SetUseVectorised(bool value) { use_vectorised_ = value; }
...
//////////////////////////////////////////////////
void LinearRegularWaveSimulation::Impl::SetAmplitude(double value) { amplitude_ = value; }

//////////////////////////////////////////////////
void LinearRegularWaveSimulation::Impl::SetPeriod(double value) { period_ = value; }

//////////////////////////////////////////////////
void LinearRegularWaveSimulation::Impl::SetTime(double value) { time_ = value; }

//////////////////////////////////////////////////
void LinearRegularWaveSimulation::Impl::Elevation(double x, double y, double & eta)
{
  double w, wt, k, cd, sd;
  PreComputeCoeff(period_, time_, wave_angle_, w, wt, k, cd, sd);
...
//////////////////////////////////////////////////
void LinearRegularWaveSimulation::Impl::Pressure(double x, double y, double z, double & pressure)
{
  double w, wt, k, cd, sd;
  PreComputeCoeff(period_, time_, wave_angle_, w, wt, k, cd, sd);
...
//////////////////////////////////////////////////
void LinearRegularWaveSimulation::Impl::ElevationAt(Eigen::Ref<Eigen::ArrayXXd> h)
{
  ...
  if (use_vectorised_)
  {
    Eigen::ArrayXXd a = k * (x_grid_ * cd + y_grid_ * sd) - wt;
...
void LinearRegularWaveSimulation::Impl::DisplacementAndDerivAt(
  ...
  Eigen::Ref<Eigen::ArrayXXd> /*dsydy*/, Eigen::Ref<Eigen::ArrayXXd> /*dsxdy*/)
{
  // derived wave properties
  double w, wt, k, cd, sd;
  PreComputeCoeff(period_, time_, wave_angle_, w, wt, k, cd, sd);
...
//////////////////////////////////////////////////
void LinearRegularWaveSimulation::Impl::ElevationAt(Index ix, Index iy, double & h)
{
  double x = ix * dx_ + lx_min_;
  double y = iy * dy_ + ly_min_;
  Elevation(x, y, h);
...
//////////////////////////////////////////////////
void LinearRegularWaveSimulation::Impl::PressureAt(Index ix, Index iy, Index iz, double & pressure)
{
  double x = ix * dx_ + lx_min_;
  double y = iy * dy_ + ly_min_;
  double z = z_(iz);
...
//////////////////////////////////////////////////
void LinearRegularWaveSimulation::Impl::PressureAt(Index iz, Eigen::Ref<Eigen::ArrayXXd> pressure)
{
  // derived wave properties
  double w, wt, k, cd, sd;
  PreComputeCoeff(period_, time_, wave_angle_, w, wt, k, cd, sd);
...
//////////////////////////////////////////////////
LinearRegularWaveSimulation::LinearRegularWaveSimulation(double lx, double ly, Index nx, Index ny)
...
//////////////////////////////////////////////////
void LinearRegularWaveSimulation::SetUseVectorised(bool value) { impl_->SetUseVectorised(value); }
...
//////////////////////////////////////////////////
void LinearRegularWaveSimulation::SetAmplitude(double value) { impl_->SetAmplitude(value); }

//////////////////////////////////////////////////
void LinearRegularWaveSimulation::SetPeriod(double value) { impl_->SetPeriod(value); }
...
//////////////////////////////////////////////////
void LinearRegularWaveSimulation::SetTime(double value) { impl_->SetTime(value); }

//////////////////////////////////////////////////
Index LinearRegularWaveSimulation::SizeX() const { return impl_->nx_; }

//////////////////////////////////////////////////
Index LinearRegularWaveSimulation::SizeY() const { return impl_->ny_; }

//////////////////////////////////////////////////
Index LinearRegularWaveSimulation::SizeZ() const { return impl_->nz_; }

//////////////////////////////////////////////////
void LinearRegularWaveSimulation::Elevation(double x, double y, double & eta) const
{
...
//////////////////////////////////////////////////
void LinearRegularWaveSimulation::Pressure(double x, double y, double z, double & pressure) const
{
...
//////////////////////////////////////////////////
void LinearRegularWaveSimulation::ElevationAt(Eigen::Ref<Eigen::ArrayXXd> h) const
{
  impl_->ElevationAt(h);
}
  ...
  Eigen::Ref<Eigen::ArrayXXd> dsxdy) const
{
  ...
  impl_->DisplacementAndDerivAt(h, sx, sy, dhdy, dhdx, dsxdx, dsydy, dsxdy);
}

//////////////////////////////////////////////////
void LinearRegularWaveSimulation::ElevationAt(Index ix, Index iy, double & eta) const
{
...
//////////////////////////////////////////////////
void LinearRegularWaveSimulation::PressureAt(Index ix, Index iy, Index iz, double & pressure) const
{
  impl_->PressureAt(ix, iy, iz, pressure);
}

//////////////////////////////////////////////////
void LinearRegularWaveSimulation::PressureAt(Index iz, Eigen::Ref<Eigen::ArrayXXd> pressure) const
{
