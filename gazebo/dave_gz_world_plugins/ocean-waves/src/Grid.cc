...
//////////////////////////////////////////////////
Grid::Grid(const std::array<double, 2> & _size, const std::array<Index, 2> & _cellCount)
...
//////////////////////////////////////////////////
Grid::Grid(const Grid & _other) : data(new GridPrivate())
{
...
//////////////////////////////////////////////////
std::shared_ptr<const cgal::Mesh> Grid::GetMesh() const { return this->data->mesh; }

//////////////////////////////////////////////////
std::shared_ptr<cgal::Mesh> Grid::GetMesh() { return this->data->mesh; }

//////////////////////////////////////////////////
const cgal::Mesh & Grid::GetMeshByRef() const { return *this->data->mesh; }

//////////////////////////////////////////////////
const std::array<double, 2> & Grid::GetSize() const { return this->data->size; }

//////////////////////////////////////////////////
const std::array<Index, 2> & Grid::GetCellCount() const { return this->data->cellCount; }

//////////////////////////////////////////////////
Index Grid::GetVertexCount() const { return this->data->mesh->number_of_vertices(); }

//////////////////////////////////////////////////
Index Grid::GetFaceCount() const { return this->data->mesh->number_of_faces(); }
...
//////////////////////////////////////////////////
const cgal::Vector3 & Grid::GetNormal(Index _idx) const { return this->data->normals[_idx]; }
...
//////////////////////////////////////////////////
const cgal::Point3 & Grid::GetCenter() const { return this->data->center; }

//////////////////////////////////////////////////
void Grid::SetCenter(const cgal::Point3 & _center) { this->data->center = _center; }
  ...
  const std::array<Index, 3> & _index, cgal::Point3 & _intersection)
{
  ...
  return Geometry::LineIntersectsTriangle(_origin, _direction, p0, p1, p2, _intersection);
}
  ...
  std::array<Index, 3> & _index, cgal::Point3 & _intersection)
{
  ...
  bool isFound = FindIntersectionTriangle(_grid, _origin, _direction, _index, _intersection);
  if (isFound)
  {
    return true;
  }
  _index[2] = (_index[2] == 0) ? 1 : 0;
  return FindIntersectionTriangle(_grid, _origin, _direction, _index, _intersection);
}
...
bool GridTools::FindIntersectionGrid(
  const Grid & _grid, const cgal::Point3 & _origin, const cgal::Direction3 & _direction,
  std::array<Index, 3> & _index, cgal::Point3 & _point)
{
