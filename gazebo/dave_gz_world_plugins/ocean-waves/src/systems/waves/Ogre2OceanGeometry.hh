...
class GZ_RENDERING_OGRE2_VISIBLE Ogre2OceanGeometry : public BaseOceanGeometry<Ogre2Geometry>
{
  /// \brief Constructor
public:
  explicit Ogre2OceanGeometry();

  /// \brief Destructor
public:
  virtual ~Ogre2OceanGeometry();
...
private:
  std::unique_ptr<Ogre2OceanGeometryPrivate> dataPtr;
};
