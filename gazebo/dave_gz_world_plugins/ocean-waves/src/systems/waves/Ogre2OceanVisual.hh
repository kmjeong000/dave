...
class GZ_RENDERING_OGRE2_VISIBLE Ogre2OceanVisual : public BaseOceanVisual<Ogre2Visual>
{
  /// \brief Constructor
public:
  Ogre2OceanVisual();
...
private:
  std::unique_ptr<Ogre2OceanVisualPrivate> dataPtr;
};
