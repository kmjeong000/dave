...
class DynamicGeometry : public System, public ISystemConfigure, public ISystemPreUpdate
{
  /// \brief Constructor
public:
  DynamicGeometry();
...
private:
  std::unique_ptr<DynamicGeometryPrivate> dataPtr;
};
