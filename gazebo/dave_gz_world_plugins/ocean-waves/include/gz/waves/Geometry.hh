...
public:
  ...
  /// \return           The triangle area
  static double TriangleArea(const cgal::Triangle & _tri);
  ...
  /// \param[in] _tri   A triangle.
  /// \return           The triangle centroid
  static cgal::Point3 TriangleCentroid(const cgal::Triangle & _tri);
  ...
  /// \return           The midpoint
  static cgal::Point3 MidPoint(const cgal::Point3 & _p0, const cgal::Point3 & _p1);
  ...
  static cgal::Vector3 Normal(
    const cgal::Point3 & _v0, const cgal::Point3 & _v1, const cgal::Point3 & _v2);
  ...
  /// \param[in] _tri   A triangle.
  /// \return           The normal vector.
  static cgal::Vector3 Normal(const cgal::Triangle & _tri);
  ...
  /// \return           The normal vector.
  static cgal::Vector3 Normal(const cgal::Mesh & _mesh, cgal::FaceIndex _face);
  ...
  /// \param[in] _face    A face index for the surface mesh.
  /// \return             A triangle.
  static cgal::Triangle MakeTriangle(const cgal::Mesh & _mesh, cgal::FaceIndex _face);

  /// \brief Create an AABB tree for the input mesh.
  ///
  /// \param[in] _mesh            The mesh to search.
  /// \return                     The built AABB tree.
  static std::shared_ptr<cgal::AABBTree> MakeAABBTree(const cgal::Mesh & _mesh);
