...
///
class LinearRegularWaveSimulation : public IWaveSimulation, public IWaveField
{
public:
  ~LinearRegularWaveSimulation();

  LinearRegularWaveSimulation(double lx, double ly, Index nx, Index ny);

  LinearRegularWaveSimulation(double lx, double ly, double lz, Index nx, Index ny, Index nz);
