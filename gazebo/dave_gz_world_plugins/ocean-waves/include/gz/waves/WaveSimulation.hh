...
public:
  ...
  virtual void Elevation(double x, double y, double & eta) const = 0;
  ...
  virtual void Pressure(double x, double y, double z, double & pressure) const = 0;

  virtual void Pressure(
    const Eigen::Ref<const Eigen::ArrayXd> & x, const Eigen::Ref<const Eigen::ArrayXd> & y,
    const Eigen::Ref<const Eigen::ArrayXd> & z, Eigen::Ref<Eigen::ArrayXd> pressure) const = 0;
};
...
public:
  ...
  virtual void ElevationAt(Index ix, Index iy, double & eta) const = 0;

  virtual void DisplacementAt(Index ix, Index iy, double & sx, double & sy) const = 0;

  virtual void PressureAt(Index ix, Index iy, Index iz, double & pressure) const = 0;

  // lookup interface - array
  virtual void ElevationAt(Eigen::Ref<Eigen::ArrayXXd> h) const = 0;

  virtual void ElevationDerivAt(
    Eigen::Ref<Eigen::ArrayXXd> dhdx, Eigen::Ref<Eigen::ArrayXXd> dhdy) const = 0;

  virtual void DisplacementAt(
    Eigen::Ref<Eigen::ArrayXXd> sx, Eigen::Ref<Eigen::ArrayXXd> sy) const = 0;
  ...
  virtual void PressureAt(Index iz, Eigen::Ref<Eigen::ArrayXXd> pressure) const = 0;
};
